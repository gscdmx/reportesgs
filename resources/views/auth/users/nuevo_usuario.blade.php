    ...
    <div class="card-body">
      ...
      @endif
        ...
        <div class="form-group row">
         ...
         <div class="line"></div>
           <div class="form-group row">
             <label class="col-sm-3 form-control-label">Este usuario pertenece a la Alcaldía:</label>
             <div class="col-sm-9 mb-3">
              <select name="delegacion_user" id="delegacion_user" class="form-control" required>
             ...
             @if ($errors->has('delegacion_user')) <p  style="color: red">{{ $errors->first('delegacion_user') }}</p> @endif 
          </div>
