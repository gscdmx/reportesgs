...
<html>
  <head>
    ...
    <title>APP MINUTAS RJG CDMX</title>
          ...
          <ul id="side-main-menu" class="side-menu list-unstyled"> 
            ...
            <?php if(in_array(1, $array_permisos)):?>
             ...
             <?php endif?>
              ...
              <li><a href="#exampledropdownDropdown_1" aria-expanded="false" data-toggle="collapse"> <i class="icon-list"></i>REPORTES DE RJG </a>
              <ul id="exampledropdownDropdown_1" class="collapse list-unstyled ">
              <li><a href="{{url('/reporte')}}"> <i class="icon-list"></i>MIS REPORTES</a></li>
              <li><a href="{{url('/getlistadoreportes')}}"> <i class="icon-list"></i>VER MIS REPORTES</a></li>          
              </ul>
              </li>
              <?php endif?>

               <?php if(in_array(3, $array_permisos)):?>
               <li><a href="#exampledropdownDropdown_2" aria-expanded="false" data-toggle="collapse"> <i class="icon-list"></i>MINUTAS DE RJG </a>
               <ul id="exampledropdownDropdown_2" class="collapse list-unstyled ">
               <li><a href="{{url('/minutasrjg')}}"> <i class="icon-list"></i>MIS MINUTAS</a></li>
               <li><a href="{{url('/getlistadominutas')}}"> <i class="icon-list"></i>VER MINUTAS</a></li>           
               </ul>
               </li>
               <?php endif?>
              ...
              <li><a href="#exampledropdownDropdown__4" aria-expanded="false" data-toggle="collapse"> <i class="icon-list"></i>SEGUIMIENTO DE MINUTAS RJG</a>
              <ul id="exampledropdownDropdown__4" class="collapse list-unstyled ">
              <li><a href="{{url('/seguimientominutas')}}"> <i class="icon-list"></i>SEGUIMIENTO DE MINUTAS</a></li>
              <li><a href="{{url('/getlistadoseguimientominutas')}}"> <i class="icon-list"></i>VER MI SEGUIMIENTO DE MINUTAS</a></li>                     
              </ul>
              </li>
              <?php endif?>
              ...
              <li><a href="#exampledropdownDropdown__REPORTESTODO" aria-expanded="false" data-toggle="collapse"> <i class="icon-list"></i>REPORTES GENERALES DE USUARIOS(C.T)</a>
              <ul id="exampledropdownDropdown__REPORTESTODO" class="collapse list-unstyled ">
              <li><a href="{{url('/reportes_generales_todos')}}"> <i class="icon-list"></i>REPORTES DE TODAS LAS C.T</a></li>                    
              </ul>
              </li>
              <?php endif?>
              ...
              <li><a href="{{url('/usuarioimagenView')}}"> <i class="icon-list"></i>Imagenes y pdfs</a></li>
              <?php endif?>                  
...
<!-- Button trigger modal -->
                ...
                <li class="nav-item"><a href="{{ route('logout') }}"  onclick="event.preventDefault();
                                                     document.getElementById('logout-form').submit();" class="nav-link logout"> <span class="d-none d-sm-inline-block">Desconectarse</span><i class="fa fa-sign-out"></i></a>
