...
<div class="col-lg-12">
  <div class="card">
    <div class="card-header d-flex align-items-center">
      <h4>SEGUIMIENTO DE MINUTAS CGGSCyPJ CDMX </h4>
    </div>
    <div class="card-header d-flex align-items-center">
      <h4>SEGUIMIENTO DE MINUTAS RJG</h4>
      
    </div>
    <div class="card-body">
      <form class="form-horizontal" enctype="multipart/form-data" method="POST" action="{{ url('/guardar_cuestionario_seguimientominutas') }}">
      ...
      <div class="line"></div>
        ...
        <div class="form-group row">
          <div class="col-sm-6 offset-sm-6">
            <button type="submit" class="btn btn-primary"> Registrar Seguimiento Minuta</button>
          </div>
        </div>
      </form>
    </div>
